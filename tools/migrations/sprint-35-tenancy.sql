...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505072830_Add_TenantCompletenessAndSlaSettings') THEN
    CREATE TABLE tenancy.tenant_completeness_settings (
        "Id" uuid NOT NULL,
        "TenantId" bigint NOT NULL,
        "RequirementId" character varying(128) NOT NULL,
        "Enabled" boolean NOT NULL DEFAULT TRUE,
        "MinThreshold" numeric(9,4),
        "UpdatedAt" timestamp with time zone NOT NULL,
        "UpdatedByUserId" uuid,
        CONSTRAINT "PK_tenant_completeness_settings" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505072830_Add_TenantCompletenessAndSlaSettings') THEN
    CREATE TABLE tenancy.tenant_sla_settings (
        "Id" uuid NOT NULL,
        "TenantId" bigint NOT NULL,
        ...
        "UpdatedAt" timestamp with time zone NOT NULL,
        "UpdatedByUserId" uuid,
        CONSTRAINT "PK_tenant_sla_settings" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505072830_Add_TenantCompletenessAndSlaSettings') THEN
    CREATE UNIQUE INDEX ux_tenant_completeness_settings_tenant_req ON tenancy.tenant_completeness_settings ("TenantId", "RequirementId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505072830_Add_TenantCompletenessAndSlaSettings') THEN
    CREATE UNIQUE INDEX ux_tenant_sla_settings_tenant_window ON tenancy.tenant_sla_settings ("TenantId", "WindowName");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505072830_Add_TenantCompletenessAndSlaSettings') THEN
    INSERT INTO tenancy."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260505072830_Add_TenantCompletenessAndSlaSettings', '10.0.7');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505115000_Add_FeatureFlags_And_TenantSettings') THEN
    CREATE TABLE tenancy.feature_flags (
        "Id" uuid NOT NULL DEFAULT (gen_random_uuid()),
        "TenantId" bigint NOT NULL,
        "FlagKey" character varying(128) NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505115000_Add_FeatureFlags_And_TenantSettings') THEN
    CREATE UNIQUE INDEX ux_feature_flags_tenant_flag ON tenancy.feature_flags ("TenantId", "FlagKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505115000_Add_FeatureFlags_And_TenantSettings') THEN
    CREATE UNIQUE INDEX ux_tenant_settings_tenant_key ON tenancy.tenant_settings ("TenantId", "SettingKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM tenancy."__EFMigrationsHistory" WHERE "MigrationId" = '20260505115000_Add_FeatureFlags_And_TenantSettings') THEN
    INSERT INTO tenancy."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260505115000_Add_FeatureFlags_And_TenantSettings', '10.0.7');
    END IF;
END $EF$;
COMMIT;
