...
namespace NickERP.Inspection.Database.Migrations
{
    ...
    [Migration("20260507130546_Add_QueueingPlatform")]
    partial class Add_QueueingPlatform
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NickERP.Inspection.Core.Entities.InspectionWorkItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("IdempotencyAnchor")
                        .IsRequired()
                        .HasMaxLength(128)
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_work_items_tenant");

                    b.HasIndex("TenantId", "CaseId")
                        .HasDatabaseName("ix_work_items_tenant_case");

                    b.ToTable("work_items", "inspection");
                });
            ...
            modelBuilder.Entity("NickERP.Platform.Queueing.Entities.WorkItemTransition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
