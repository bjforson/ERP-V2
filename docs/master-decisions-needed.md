...
**Implementation shipped 2026-04-29** — Sprint 5, merge commit `5a1938c`
(feature commit `63063a7`). See `docs/system-context-audit-register.md`
for the audit register that tracks every `SetSystemContext()` caller
going forward.
