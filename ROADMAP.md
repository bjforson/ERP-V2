...
| **Multi-tenant day 1** | `ITenantOwned` + interceptor + 180+ RLS policies + 5-entry system-context audit register. Tenant lifecycle Pt 1 (state + soft-delete + hard-purge admin) shipped Sprint 18 (2026-05-04); Pt 2 (email service + first-user invite) Sprint 21; Pt 3 (scoped export) Sprint 22+. | 🟡 RLS mature. Lifecycle Pt 1 ✅; Pt 2 + Pt 3 still queued. |
