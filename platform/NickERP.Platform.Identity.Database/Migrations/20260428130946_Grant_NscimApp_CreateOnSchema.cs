...
namespace NickERP.Platform.Identity.Database.Migrations
{
    ...
    public partial class Grant_NscimApp_CreateOnSchema : Migration
    {
        ...
        {
            migrationBuilder.Sql("GRANT CREATE ON SCHEMA identity TO nscim_app;");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("REVOKE CREATE ON SCHEMA identity FROM nscim_app;");
        }
    }
}
